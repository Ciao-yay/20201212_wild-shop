<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <i class="content-icon" @click="showShopModal=true"></i>
        </h2>
    ...
    <div class="shop-header-discounts" v-if="seller.supports">
      <div class="discounts-left">
        <div class="activity" :class="`activity-${colors[seller.supports[0].type]}`">
          <span class="content-tag">
            <span class="mini-tag">{{seller.supports[0].name}}</span>
          </span>
          <span class="activity-content ellipsis">{{seller.supports[0].content}}</span>
        </div>
      </div>
      <div class="discounts-right" @click="showActivitySheet=true">{{seller.supports.length}} 个优惠</div>
    </div>
    <div class="shop-brief-modal" v-if="showShopModal">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="showShopModal=false">
    ...
    <div class="activity-sheet" v-if="showActivitySheet">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item" :class="`activity-${colors[support.type]}`" v-for="(support,index) in seller.supports" :key="index">
            <span class="content-tag">
      ...
      <div class="activity-sheet-cover" @click="showActivitySheet=false" ></div>
    </div>
  </div>
</template>
<script>
